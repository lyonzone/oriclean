...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Forklift</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('forklift'); ?>" method="get">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-forklift_optr"> Forklift Optr</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("forklift/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-forklift_optr">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['forklift_optr']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("forklift/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="forklift_optr" 
                                                            data-title="Enter Forklift Operator" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                            ...
                                                            <?php echo $data['forklift_optr']; ?> 
                                                        </span>
                                                    </td>
                                                    <th class="td-btn">
                                                        <?php if($can_view){ ?>
                                                        <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("forklift/view/$rec_id"); ?>">
                                                            <i class="fa fa-eye"></i> View
                                                        </a>
                                                        <?php } ?>
                                                        <?php if($can_edit){ ?>
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("forklift/edit/$rec_id"); ?>">

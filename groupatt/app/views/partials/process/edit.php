...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Production Log Book</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("process/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="row">
                                    <div class="form-group col-sm-4">
                                        ...
                                        <div class="form-group col-sm-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-pink"  value="<?php  echo $data['pink']; ?>" type="text" placeholder="Enter Pink (Batch)"  required="" name="pink"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-2">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-blue"  value="<?php  echo $data['blue']; ?>" type="text" placeholder="Enter Blue (Batch)"  required="" name="blue"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-sm-2">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-domex"  value="<?php  echo $data['domex']; ?>" type="text" placeholder="Enter Domex (Batch)"  required="" name="domex"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-sm-2">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-easywash"  value="<?php  echo $data['easywash']; ?>" type="text" placeholder="Enter Easywash G1 (Batch)"  required="" name="easywash"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-sm-2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-fg"  value="<?php  echo $data['fg']; ?>" type="text" placeholder="Enter Fg (Batch)"  required="" name="fg"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-sm-2">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-batch_size"  value="<?php  echo $data['batch_size']; ?>" type="text" placeholder="Enter EW Batch Size"  required="" name="batch_size"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group col-sm-6">
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <input id="ctrl-man_other"  value="<?php  echo $data['man_other']; ?>" type="text" placeholder="Enter Manpower shifted to other location"  required="" name="man_other"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group col-sm-2">
                                                                            ...
                                                                            <div class="form-group col-sm-2">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <div class="">
                                                                                            <input id="ctrl-Wh150m2"  value="<?php  echo $data['Wh150m2']; ?>" type="number" placeholder="Enter Wh150m2" step="1"  required="" name="Wh150m2"  class="form-control " />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group col-sm-2">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-8">
                                                                                            <div class="">
                                                                                                <input id="ctrl-Wh150m3"  value="<?php  echo $data['Wh150m3']; ?>" type="number" placeholder="Enter Wh150m3" step="1"  required="" name="Wh150m3"  class="form-control " />
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group col-sm-2">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-8">
                                                                                                <div class="">
                                                                                                    <input id="ctrl-Wh150m4"  value="<?php  echo $data['Wh150m4']; ?>" type="number" placeholder="Enter Wh150m4" step="1"  required="" name="Wh150m4"  class="form-control " />
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>

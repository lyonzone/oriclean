...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Wastagelogs</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("wastagelogs/add") ?>">
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('wastagelogs'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('wastagelogs'); ?>">
                ...
                <div class="row mx-auto">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class="bg-light animated fadeIn page-content">
                            <div id="wastagelogs-list-records">
                                <div id="page-report-body" class="table-responsive">
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light text-danger">
                                            <tr>
                                                <th class="td-sno">#</th>
                                                <th  class="td-date"> Date</th>
                                                <th  class="td-shift"> Shift</th>
                                                <th  class="td-grp"> Group</th>
                                                <th  class="td-mcn"> Machine No</th>
                                                <th  class="td-pouches"> Pouches</th>
                                                <th  class="td-trial"> Trial Wastage (in KG)</th>
                                                <th  class="td-leaker"> Leaker wastage (in KG)</th>
                                                <th  class="td-damage"> Damage Wastage (in KG)</th>
                                                <th  class="td-powder_wast"> Powder Wastage</th>
                                    ...
                                    <div class="row justify-content-center">    
                                        <div class="col-md-auto justify-content-center">    
                                            <div class="p-3 d-flex justify-content-between">    
                                                <?php if($can_delete){ ?>
                                                <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("wastagelogs/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">

...
class UserController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($this->search)){
			...
			$db->where("(id LIKE ? OR user_name LIKE ? OR password LIKE ? OR email LIKE ? OR phone_no LIKE ?)", array("%$text%","%$text%","%$text%","%$text%","%$text%"));
		}
	...
	function add(){
		if(is_post_request()){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename = 'user';
			$fields = $this->fields = array('user_name','password','email','phone_no'); //insert fields
	...
	function edit($rec_id = null){
		...
		$this->rec_id = $rec_id;
		$tablename = $this->tablename = 'user';
		$fields = $this->fields = array('id','user_name','phone_no'); //editable fields
		if(is_post_request()){
			Csrf :: cross_check();
			$postdata = $this->transform_request_data($_POST);
			$this->rules_array = array(

<?php
	...
	class PageAccessManager{
		...
		public static $usersRolePermissions=array(
			'administrator' =>
						array(
							'record' => array('list','view','add','edit', 'editfield','delete'),
							'user' => array('list','view','add','edit', 'editfield','delete','accountedit','accountview','userregister')
						),
		
			'user' =>
						array(
							'record' => array('list','view','add','edit', 'editfield')
						)
		);

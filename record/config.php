...
define("SITE_NAME", "Record Room Management");
...
define("APP_ID", "222472daae80249cdcef325cd5335793");
...
define("META_AUTHOR", "Record Room Management");
define("META_DESCRIPTION", "Record Room Management");
define("META_KEYWORDS", "Record Room Management");
...
define("DB_USERNAME", "sahjjwfk_record");
define("DB_PASSWORD", "sahjjwfk_record");
define("DB_NAME", "sahjjwfk_record");
...
define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['ph_no'] : null ));
